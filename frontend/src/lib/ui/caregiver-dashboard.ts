...
/** Shared ElderCare caregiver dashboard design tokens (matches landing + auth). */
export const cd = {
  ...
  input:
    "h-14 w-full rounded-2xl border border-[#d8d8d8] bg-white px-5 text-[15px] text-[#111111] outline-none transition focus:border-[#ff6a3d] disabled:bg-[#f5f5f3] disabled:text-[#8ca09a]",
  select:
  ...
  btnSecondary:
    "inline-flex h-11 items-center justify-center rounded-full border border-[#d8d8d8] bg-white px-5 text-sm font-semibold text-[#111111] transition hover:border-[#cad5d2] disabled:cursor-not-allowed disabled:opacity-60",
  btnGhost:
    "inline-flex h-9 items-center justify-center rounded-full border border-[#d8d8d8] bg-white px-4 text-xs font-semibold text-[#111111] transition hover:border-[#cad5d2] disabled:cursor-not-allowed disabled:opacity-60",
  btnSuccess:
    "inline-flex h-9 items-center justify-center rounded-full bg-[#4a6b5c] px-4 text-xs font-semibold text-white transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-60",
  btnDanger:
    "inline-flex h-9 items-center justify-center rounded-full border border-[#e8c4c4] bg-white px-4 text-xs font-semibold text-[#9b4d4d] transition hover:border-[#d4a8a8] disabled:cursor-not-allowed disabled:opacity-60",
  ...
  tableWrap: "overflow-x-auto rounded-2xl border border-[#e7e7e7]",
  ...
  badge: "inline-flex rounded-full px-3 py-1 text-xs font-semibold capitalize",
  serviceChip:
    "flex cursor-pointer items-start gap-3 rounded-2xl border border-[#e7e7e7] bg-white p-4 transition has-[:checked]:border-[#ff6a3d]/40 has-[:checked]:bg-[#fff8f5]",
  kpiCard:
    "rounded-[24px] border border-[#e7e7e7] bg-white p-6 shadow-sm transition hover:border-[#cad5d2]",
} as const;
...
export const VERIFICATION_STYLES: Record<CaregiverProfile["verificationStatus"], string> = {
  pending: "bg-[#f5efe6] text-[#8a6d3b]",
  verified: "bg-[#e8f0ec] text-[#3d6b55]",
  rejected: "bg-[#f5e8e8] text-[#9b4d4d]",
};

export { getGreeting } from "@/lib/ui/user-dashboard";
