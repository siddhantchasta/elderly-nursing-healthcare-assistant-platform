...
const NAV_ITEMS = [
  ...
  { href: "/caregiver/profile", label: "My profile", icon: UserCircle },
  { href: "/caregiver/bookings", label: "Bookings", icon: Calendar },
  { href: "/caregiver/work-history", label: "Work history", icon: History },
  { href: "/caregiver/complaints", label: "Complaints", icon: MessageSquare },
] as const;

function isActive(pathname: string, href: string) {
  if (href === "/caregiver/dashboard") return pathname === href;
  return pathname === href || pathname.startsWith(`${href}/`);
}

export default function CaregiverDashboardShell({ children }: { children: React.ReactNode }) {
